...
export default function TaskModal({ card, onClose, onSave, onDelete }) {
  ...
  return (
      <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-3 sm:items-start sm:p-4 sm:pt-16"
          onClick={onClose}
      >
        <div
            className="flex max-h-full w-full max-w-lg flex-col rounded-xl bg-white shadow-2xl"
        ...
        >
          ...
          <div className="flex shrink-0 flex-col-reverse gap-3 border-t border-slate-100 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <button
                onClick={onDelete}
