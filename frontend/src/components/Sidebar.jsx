...
export default function Sidebar({ groups, selectedId, onSelect, onCreate, onDelete, open, onClose }) {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-40 flex w-72 max-w-[85vw] shrink-0 flex-col bg-board-dark text-white transition-transform duration-200 ease-out md:static md:z-auto md:w-64 md:translate-x-0 ${
                    open ? 'translate-x-0' : '-translate-x-full'
                }`}
            >
                <div className="flex items-center justify-between border-b border-white/20 px-4 py-5">
                    <div>
